...
export default function AmountDisbursedChart({ onClickDrawer }) {
      ...
      <Grid container width="100%" height="40rem" mb={3} bgcolor="common.white">
        <Grid container width="100%" height="2.5rem" p={3}>
          <Grid item xs={9}>
            <Text
              variant="subtitle1"
              children="Amount demand from bank vs disbursed"
            />
          </Grid>
        ...
        <ResponsiveContainer width="90%" height="60%">
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="demanded" barSize={30} fill="#92D7F4" />
