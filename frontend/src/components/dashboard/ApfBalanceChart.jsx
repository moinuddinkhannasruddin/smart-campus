...
const customYAxisValues = [0, 5, 10, 15, 20, 30];

export default function ApfBalanceChart({ onClickDrawer }) {
    ...
    <>
      <Grid container width="100%" height="40rem" mb={3} bgcolor="common.white">
        <Grid container width="100%" height="2.5rem" p={3}>
          <Grid item xs={9}>
            <Text variant="subtitle1" children="APF Balance limit of banks" />
          </Grid>
        ...
        <ResponsiveContainer width="90%" height="60%">
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="remaining" barSize={50} fill="#92D7F4" />
            {/* <Bar dataKey="disbur"  barSize={50} fill="#1A6989" /> */}
          </BarChart>
        </ResponsiveContainer>
      </Grid>
    </>
